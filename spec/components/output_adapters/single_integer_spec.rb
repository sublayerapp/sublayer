...
RSpec.describe Sublayer::Components::OutputAdapters::SingleInteger do
  let(:name) { 'output_adapter_name' }
  let(:description) { 'output_adapter_description' }
  let(:output_adapter) { Sublayer::Components::OutputAdapters::SingleInteger.new(name: name, description: description) }
