...
RSpec.describe Sublayer::Components::OutputAdapters::SingleString do
  let(:name) { 'output_adapter_name' }
  let(:description) { 'output_adapter_description' }
  let(:output_adapter) { Sublayer::Components::OutputAdapters::SingleString.new(name: name, description: description) }
