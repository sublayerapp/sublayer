  ...
  module Agents
    class GenerateSublayerAgentAgent
      ...
      def prompt
        ...
        The LLMAssistance module has a generate_to_single_function_call method that takes the prompt and result function and sends it to an LLM for processing
